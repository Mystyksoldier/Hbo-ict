...
"""
#       TODO: iteratie 1: [ 3, 4, 1, 2 ], iteratie 2: [ 3, 1, 4, 2 ],
#             iteratie 3: [ 1, 3, 4, 2 ], iteratie 4: [ 1, 3, 2, 4 ], iteratie 5: [ 1, 2, 3, 4 ], 
"""
...
"""
#           TODO: beste scenario : [1,2,3]:  3 iteraties, 0 veranderingen
"""
...
"""
#           TODO: slechtse scenario : [3, 2, 1]: 7 iteraties, 3 veranderingen.
"""
        ...
        -   Stel je hebt een lijst met de waarden 1 tot en met 4.
            ...
            Hoeveel vergelijkingen zijn er nodig?
"""
#           TODO: beste case scenario : [1,2,3,4]: 4 iteraties, 0 veranderingen. 
#               slechtse case scenario: [4,3,2,1]: 14 iteraties, 6 veranderingen
"""
...
def linear_search_recursive(lst, target):
    ...
    # Controleer het eerste element
    if lst[0] == target:
        return True
    
    # Roep de functie recursief aan voor de rest van de lijst
